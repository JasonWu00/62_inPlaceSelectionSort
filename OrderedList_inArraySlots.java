...
public class OrderedList_inArraySlots
    ...
    public OrderedList_inArraySlots ( ArrayList<Integer> unordered) {
      int currentEle = 0;
      for (int loopTimes = 0; loopTimes < unordered.size(); loopTimes++) {
        int lowestElementIndex = champIndex(loopTimes, unordered);
        int lowestElement = unordered.get(lowestElementIndex);
        unordered.set(lowestElementIndex, unordered.get(loopTimes));
        unordered.set(loopTimes, lowestElement);
      }
    ...
    /**
      ...
      @return the index of the lowest element of the given ArrayList.
     */
     private int champIndex( int startAt, ArrayList<Integer> challengers) {
